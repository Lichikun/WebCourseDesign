...
public class SocialAccountsController {
    ...
    public Result save(@RequestBody SocialAccounts socialAccounts) {

        Result result = new Result();

        socialAccountsService.add(socialAccounts);
        result.success("添加成功");
    ...
    public Result deleteByIds(String ids){
        Result result = new Result();
        socialAccountsService.deleteByIds(ids);
        result.success("删除成功");
    ...
    public Result update(@RequestBody SocialAccounts socialAccounts){
        Result result = new Result();

        socialAccountsService.update(socialAccounts);
        result.success("修改成功");
    ...
    public Result updateUsefulByIds(String id,Boolean flag) {
        Result result = new Result();
        socialAccountsService.updateUsefulByIds(id,flag);
        result.success("更新成功");
        return result;
    }
    ...
    public Result listByValue(String value,String name){
        ...
        result.setData(socialAccountsService.listByValue(value,name));
        return result;
    }
    ...
    public Result page( Integer pageNum,Integer pageSize,String name ){
        Result result = new Result();
        result.success("获取list成功");
        result.setData(socialAccountsService.page(pageNum,pageSize,name));
        return result;
    }
}
